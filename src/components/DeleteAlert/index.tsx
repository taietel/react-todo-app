...
export default function DeleteAlert({show, onClose, onConfirmAction, title, description}: DeleteAlertProps) {
  ...
  return <Modal show={show} onClose={onClose}>
    <div className="sm:flex sm:items-start">
      ...
      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
        <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-slate-900 dark:text-slate-300">
          {title}
        </Dialog.Title>
        <div className="mt-2">
